...
def check_for_updates():
    ...
    fver = requests.get(
        ...
        "https://facebook.com/groups/cybercaliphateteam/"
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("CCT is up-to-date")

        mesgdcrt.GeneralMessage("Starting SMS CCT")
...
def notifyen():
    ...
    try:
        ...
        if DEBUG_MODE:
            ...
            url = "https://facebook.com/groups/cybercaliphateteam/"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("SHANTO")
...
description = """(CCT)"- Your Friendly Spammer Application

SHA4T0 can be used for many purposes which incudes -
...
SHA4T0 is not intented for malicious uses.
...
parser.add_argument("-sms", "--sms", action="store_true",
                    ...
                    help="start SHA4T0 with SMS Bomb mode")

parser.add_argument("-call", "--call", action="store_true",

                    help="start SHA4T0 with CALL Bomb mode")

parser.add_argument("-mail", "--mail", action="store_true",

                    help="start SHA4T0 with MAIL Bomb mode")
